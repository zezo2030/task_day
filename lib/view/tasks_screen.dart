...
class _TasksScreenState extends State<TasksScreen>
  ...
  final List<String> _filterOptions = ['All', 'Completed', 'Pending'];
  ...
  void _showEnhancedTaskDetails(TaskModel task) {
    ...
    final bool hasAttachments = random.nextBool();
    final int commentsCount = random.nextInt(5);
          ...
          (context) => Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [const Color(0xFF1E293B), const Color(0xFF131C2F)],
              ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Task title with floating design
                      Container(
                        padding: EdgeInsets.all(16.w),
                        decoration: BoxDecoration(
  ...
  Widget _buildFeatureButton(IconData icon, String count, String label) {
    return Container(
